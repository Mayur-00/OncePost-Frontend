  ...
  return (
    <main className="h-screen w-screen flex flex-col items-center justify-center  bg-zinc-100 text-black overflow-y-auto">
      ...
      <section className="min-h-[50%] w-[90%] md:h-[80%] md:w-[30%] lg:h-[80%] lg:w-[30%] flex flex-col items-center py-10 my-auto bg-white rounded-md shadow-2xl ">
        ...
        <form
          className="mx-auto min-h-[60%] max-h-[80%] w-[80%] flex flex-col gap-2  "
        ...
        >
          ...
          <p className="text-xs text-zinc-400">
            By clicking on the submit button you are agreeing our{" "}
          ...
          <button
            type="submit"
            className="py-1 px-4 bg-violet-500 rounded-md text-white hover:bg-violet-600 cursor-pointer flex items-center justify-center "
            disabled={loading}
          >
