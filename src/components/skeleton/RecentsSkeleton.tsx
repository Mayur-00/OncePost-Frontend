...
const RecentsSkeleton = () => {
  return (
    <section className="w-full lg:w-[60%]  h-120 overflow-y-auto flex flex-col bg-white text-black  p-5 rounded-md gap-3 outline outline-zinc-300 shadow-xl animate-pulse">
